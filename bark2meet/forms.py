...
class RegistrationUserForm(FlaskForm):
    ...
    #gender = RadioField('Gender', choices=[(1, 'Male'), (0, 'Female'), (2, "Prefer not to say")])
...
class RegistrationDogForm(FlaskForm):
    dog_name = StringField("What's your dog's name?", validators=[DataRequired(), Length(min=3, max=30)])
    dog_age = StringField("How old is your furry friend?", validators=[DataRequired(), Length(max=2)])
